...
def construct_graph(dataset, features, topk):
    fname = '/Users/liximing/Documents/BUPT_Phd/Draft/AM-GCN-Malware/data/coraml/knn/tmp.txt'
    print(fname)
    f = open(fname, 'w')
    ##### Kernel
...
def generate_knn(dataset):
    for topk in range(2, 10):
        data = np.loadtxt('/Users/liximing/Documents/BUPT_Phd/Draft/AM-GCN-Malware/data/citeseer/citeseer.feature', dtype=float)
        print(data)
        construct_graph(dataset, data, topk)
        f1 = open('/Users/liximing/Documents/BUPT_Phd/Draft/AM-GCN-Malware/data/coraml/knn/tmp.txt','r')
        f2 = open('/Users/liximing/Documents/BUPT_Phd/Draft/AM-GCN-Malware/data/coraml/knn/c' + str(topk) + '.txt', 'w')
        lines = f1.readlines()
        for line in lines:
